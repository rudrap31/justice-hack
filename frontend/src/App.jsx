          ...
          <div className="max-w-4xl mx-auto px-6 py-5">
            {attachedFiles.length > 0 && (
              <div className="mb-3 flex flex-wrap gap-2">
                {attachedFiles.map((file, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-2 bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-200 rounded-xl px-3 py-2 text-sm"
                  >
            ...
            <div className="flex gap-3 items-end">
              ...
              <button
                ...
                className="p-3.5 rounded-2xl backdrop-blur-xl bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-200 text-purple-600 hover:from-purple-100 hover:to-blue-100 transition-all duration-200 flex-shrink-0 shadow-sm hover:shadow-md"
                title="Attach files"
              >
